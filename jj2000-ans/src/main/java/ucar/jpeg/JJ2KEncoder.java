...
import ucar.jpeg.jj2000.j2k.decoder.CmdLnDecoder;
...
public class JJ2KEncoder {
    ...
    public static int[] enc = new int[300];
    public static int encPointer = 0;
    public static int[] dec = new int[300];
    public static int decPointer = 0;
    /**
